...
class SettingsWindow(QDialog):
    ...
    def _tab_models(self) -> QWidget:
        ...
        self._asr_combo.addItems(["large-v3 (local INT8)", "medium (local)", "openai/whisper-1"])
        ...
        self._use_vlm      = QCheckBox("Use full VLM (Qwen) instead of CogFlorence")
    ...
    def _tab_plugins(self) -> QWidget:
        # BUG FIX: w must be created before being passed to QVBoxLayout
        w = QWidget()
        v = QVBoxLayout(w)
